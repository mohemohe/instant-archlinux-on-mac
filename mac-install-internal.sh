...
wget -O /root/pacman_aur.sh https://raw.githubusercontent.com/shatteringlass/instant-archlinux-on-mac/master/pacman_aur.sh
chmod +x /root/pacman_aur.sh
chroot /arch bash -c /root/pacman_aur.sh
