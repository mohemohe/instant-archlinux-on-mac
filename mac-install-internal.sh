...
# chroot /arch pacman --noconfirm --needed -U /var/cache/pacman/general/*.pkg.tar.xz
chroot /arch pacman --noconfirm -Syyu --needed linux linux-headers acpi adwaita-icon-theme alsa-lib alsa-plugins alsa-utils arch-install-scripts aria2 at-spi2-atk at-spi2-core  atk  atkmm  attica-qt5  autoconf  automake  avahi  binutils  bison  bluez  bluez-libs  btrfs-progs c-ares  ca-certificates  ca-certificates-utils  cairo  cairomm  cantarell-fonts  capstone  cdparanoia  compositeproto  cpupower  ctags  damageproto  dbus  dbus-glib  dconf  desktop-file-utils  ding-libs  dkms  dnsmasq  dotconf  exo  fakeroot  feh  fftw  file  findutils  fixesproto  flac  flex  fontconfig  fontsproto  freetype2  fuse-common  fuse2  gamin  garcon  gawk  gc  gcc  gconf  gcr  gdk-pixbuf2  gettext  giflib  git  glib-networking  glib2  glibc  glibmm  gnome-icon-theme  gnome-icon-theme-symbolic  gnome-keyring  gnome-terminal  gnome-themes-standard  gnupg  gnutls  gpm  graphite  grep  grml-zsh-config  groff  gsettings-desktop-schemas  gssproxy  gst-plugins-base  gst-plugins-base-libs  gstreamer  gtk-update-icon-cache  gtk-xfce-engine  gtk2  gtk3  gtkmm3  guile  gzip  harfbuzz  harfbuzz-icu  haveged  hfsprogs  hicolor-icon-theme  htop  hwids  imagemagick  imlib2  inetutils  inputproto  intel-ucode  iproute2  iptables  iso-codes  jansson  jasper  js  json-glib  karchive  kauth  kbd  kbookmarks  kbproto  kcodecs  kcompletion  kconfig  kconfigwidgets  kcoreaddons  kcrash  kdbusaddons  kglobalaccel  kguiaddons  ki18n  kiconthemes  kinit  kio  kitemviews  kjobwidgets  kmod  knotifications  knotifyconfig  konsole  kparts  kpty  kservice  ktextwidgets  kwallet  kwidgetsaddons  kwindowsystem  kxmlgui  lcms2  lftp  libao  libasyncns  libatasmart  libatomic_ops  libbsd  libcanberra  libcanberra-pulse  libcap-ng  libcroco  libcups  libdaemon  libdatrie  libdbusmenu-qt5  libdrm  libedit  libelf  libepoxy  libevdev  libevent  libexif  libfontenc  libgudev  libical  libice  libid3tag  libimobiledevice  libinput  libjpeg-turbo  liblqr  libmm-glib  libmnl  libmpc  libndp  libnetfilter_conntrack  libnewt  libnfnetlink  libnftnl  libnl  libnm  libnm-glib  libnotify  libogg  libomxil-bellagio  libpcap  libpciaccess  libpgm  libplist  libpng  libproxy  libpulse  librsvg  libsamplerate  libseccomp  libsigc++  libsm  libsndfile  libsodium  libsoup  libsoxr  libssh2  libsystemd  libtasn1  libteam  libthai  libtheora  libtiff  libtool  libtxc_dxtn  libunwind  libusb  libusbmuxd  libutempter  libvisual  libvorbis  libwacom  libwnck  libx11  libxau  libxcb  libxcomposite  libxcursor  libxdamage  libxdmcp  libxext  libxfce4ui  libxfce4util  libxfixes  libxfont  libxfont2  libxft  libxi  libxinerama  libxkbcommon  libxkbcommon-x11  libxkbfile  libxklavier  libxml2  libxmu  libxrandr  libxrender  libxres  libxshmfence  libxslt  libxss  libxt  libxtst  libxv  libxxf86vm   linux-firmware   llvm-libs  lm_sensors  lz4  m4  make  man-pages  media-player-info   mesa-libgl  mkinitcpio  mkinitcpio-busybox  mlocate  mobile-broadband-provider-info  nano  nettle  network-manager-applet  networkmanager  nilfs-utils  nm-connection-editor  nspr  nss   ntp  ocl-icd  openal  openconnect  opus  orc  pacman  pango  pangomm  partclone  patch  pavucontrol  pciutils  pcre2  pcsclite  perl-error  perl-uri  phonon-qt5  phonon-qt5-gstreamer  pixman  pkg-config  plasma  polkit  polkit-gnome  polkit-qt5  powertop  progsreiserfs  psmisc  pulseaudio  pulseaudio-alsa  python  python-appdirs  python-capstone  python-dateutil  python-docutils  python-msgpack  python-packaging  python-pyasn1  python-pyelftools  python-pyparsing  python-rsa  python-setuptools  python-six  python-xdg  python2  qt5-base  qt5-declarative  qt5-multimedia  qt5-script  qt5-speech  qt5-svg  qt5-x11extras  qt5-xmlpatterns  randrproto  recordproto  reflector  renderproto  rsync  rtkit  scrnsaverproto  sddm   sed  shared-mime-info  slang  snappy  solid  sonnet  sound-theme-freedesktop  speech-dispatcher  speexdsp  sqlite  startup-notification  sudo  systemd  systemd-sysvcompat  tcpdump  tdb  terminus-font  testdisk  texinfo  thermald  thunar  thunar-volman  tmux  tree  tslib  ttf-dejavu   tumbler  udisks2  upower  usbmuxd  util-linux  videoproto  vim  vim-runtime  vpnc  vte-common  vte3  wayland  wayland-protocols  webrtc-audio-processing  which  wpa_supplicant  xcb-proto  xcb-util  xcb-util-image  xcb-util-keysyms  xcb-util-renderutil  xcb-util-wm  xdg-utils  xextproto  xf86-input-libinput  xf86vidmodeproto  xfce4-appfinder  xfce4-panel  xfce4-power-manager  xfce4-session  xfce4-settings  xfce4-terminal  xfce4-whiskermenu-plugin  xfconf  xfdesktop  xfwm4  xfwm4-themes  xineramaproto  xkeyboard-config  xorg-bdftopcf  xorg-font-util  xorg-font-utils  xorg-fonts-alias  xorg-fonts-encodings  xorg-fonts-misc  xorg-iceauth  xorg-mkfontdir  xorg-mkfontscale  xorg-server  xorg-server-common  xorg-sessreg  xorg-setxkbmap  xorg-xauth  xorg-xbacklight  xorg-xcmsdb  xorg-xev  xorg-xgamma  xorg-xhost  xorg-xinit  xorg-xinput  xorg-xkbcomp  xorg-xmodmap  xorg-xrandr  xorg-xrdb  xorg-xrefresh  xorg-xset  xorg-xsetroot  xproto  yajl  zeromq  zsh-syntax-highlighting
wget -O /arch/var/cache/pacman_aur.sh https://raw.githubusercontent.com/shatteringlass/instant-archlinux-on-mac/master/pacman_aur.sh
chmod +x /arch/var/cache/pacman_aur.sh
chroot /arch bash -c /var/cache/pacman_aur.sh
