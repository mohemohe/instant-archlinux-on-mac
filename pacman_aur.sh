...
wget http://repo.antergos.com/antergos/x86_64/antergos-alerts-17.6.25-1-any.pkg.tar.xz -O /tmp/antergos-alerts-17.6.25-1-any.pkg.tar.xz

pacman -U /tmp/antergos-keyring-20170524-1-any.pkg.tar.xz /tmp/antergos-mirrorlist-20170527-2-any.pkg.tar.xz /tmp/antergos-alerts-17.6.25-1-any.pkg.tar.xz --noconfirm
